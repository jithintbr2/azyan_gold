...
class _ForceUpdateState extends State<ForceUpdate> {
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text('Azyan Gold Recomend That You Update To The Latest Version.', style: TextStyle(
                  color: Colors.black,
  ...
  void _dialogue(BuildContext context) async {
    ...
    newVersion.showUpdateDialog(context: context,
      ...
      dialogTitle: "UPDATE!!!", dialogText: "Please Update The app From "+ "${status.localVersion}"+" to "+"${status.storeVersion}",
